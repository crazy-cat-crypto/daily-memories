...
4. When a browser open the website via get request the flask server asks for their email and if a match is found it displays date-journal list which the user can click to view or edit the journal of specific day.
